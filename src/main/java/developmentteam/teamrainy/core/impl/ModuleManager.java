...
import developmentteam.teamrainy.mod.modules.impl.combat.*;
import developmentteam.teamrainy.mod.modules.impl.exploit.*;
import developmentteam.teamrainy.mod.modules.impl.misc.*;
import developmentteam.teamrainy.mod.modules.impl.movement.*;
import developmentteam.teamrainy.mod.modules.impl.player.*;
import developmentteam.teamrainy.mod.modules.impl.player.freelook.FreeLook;
import developmentteam.teamrainy.mod.modules.impl.render.*;
import developmentteam.teamrainy.mod.modules.settings.Setting;
import developmentteam.teamrainy.mod.modules.settings.impl.BindSetting;
...
public class ModuleManager implements Wrapper {
    ...
    public ModuleManager() {
        ...
        addModule(new XRay());
        addModule(new RainyCrystalBase());
    ...
    public void onThread() {
        modules.stream().filter(Module::isOn).forEach(module -> {
            try {
                ...
                e.printStackTrace();
                if (HackSetting.INSTANCE.debug.getValue())
    ...
    public void render3D(MatrixStack matrixStack) {
        ...
        TeamRainy.EVENT_BUS.post(new Render3DEvent(matrixStack, mc.getTickDelta()));
        matrixStack.pop();
