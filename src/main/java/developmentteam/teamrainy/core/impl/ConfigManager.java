...
import developmentteam.teamrainy.mod.modules.impl.client.ModuleList;
...
public class ConfigManager extends Manager {
	...
	public static void resetModule() {
		for (Module module : TeamRainy.MODULE.modules) {
	...
	public void loadSettings() {
		for (Module module : TeamRainy.MODULE.modules) {
			...
			module.setState(TeamRainy.CONFIG.getBoolean(module.getName() + "_state", module instanceof HUD || module instanceof ModuleList));
		}
	}
	public void saveSettings() {
		...
		try {
			...
			printwriter.println("prefix:" + TeamRainy.PREFIX);
			...
			printwriter.println("armor_x:" + TeamRainy.GUI.armorHud.getX());
			printwriter.println("armor_y:" + TeamRainy.GUI.armorHud.getY());
			...
			System.out.println("[" + TeamRainy.NAME + "] Failed to save settings");
		} finally {
	...
	public void readSettings() {
		...
		try {
			...
			System.out.println("[" + TeamRainy.NAME + "] Failed to load settings");
		}
	}
