...
import developmentteam.teamrainy.api.interfaces.IShaderEffect;
...
public class ShaderManager implements Wrapper {
    ...
    public void setupShader(Shader shader, ManagedShaderEffect effect) {
        developmentteam.teamrainy.mod.modules.impl.render.Shader shaderChams = developmentteam.teamrainy.mod.modules.impl.render.Shader.INSTANCE;
