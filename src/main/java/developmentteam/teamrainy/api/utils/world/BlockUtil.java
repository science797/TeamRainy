package developmentteam.teamrainy.api.utils.world;
...
import developmentteam.teamrainy.mod.modules.impl.combat.AutoWeb;
...
public class BlockUtil implements Wrapper {
    ...
    public static boolean canReplace(BlockPos pos) {
        ...
        if (mc.world.getBlockState(pos).getBlock() == Blocks.COBWEB) {
            if (AutoWeb.ignore && RainyCrystal.INSTANCE.replace.getValue()) return true;
        }
    ...
    public static boolean canClick(BlockPos pos) {
        ...
        if (mc.world.getBlockState(pos).getBlock() == Blocks.COBWEB) {
            if (AutoWeb.ignore) {
                return RainyCrystal.INSTANCE.airPlace.getValue();
            }
        }
