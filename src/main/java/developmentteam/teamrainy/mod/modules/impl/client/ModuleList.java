...
public class ModuleList extends Module {
    ...
    private final EnumSetting<ColorMode> colorMode = add(new EnumSetting<>("ColorMode", ColorMode.Rainbow));
    private final SliderSetting rainbowSpeed = add(new SliderSetting("RainbowSpeed", 1.5, 1, 10, 0.1, () -> colorMode.getValue() == ColorMode.Rainbow ));
