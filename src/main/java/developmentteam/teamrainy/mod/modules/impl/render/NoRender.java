...
import developmentteam.teamrainy.api.events.impl.ParticleEvent;
...
public class NoRender extends Module {
	...
	public final BooleanSetting invisible = add(new BooleanSetting("Invisible", true));
	public final BooleanSetting potions = add(new BooleanSetting("Potions", true));
	public final BooleanSetting xp = add(new BooleanSetting("XP", false));
	...
	public final BooleanSetting campFire = add(new BooleanSetting("CampFire", true));
