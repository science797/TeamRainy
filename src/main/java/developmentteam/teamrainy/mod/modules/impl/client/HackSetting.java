...
public class HackSetting extends Module {
    public static HackSetting INSTANCE;
    ...
    public final StringSetting windowTitle = add(new StringSetting("WindowTitle", TeamRainy.NAME, () -> page.is(Page.Misc)));
    ...
    public final StringSetting hackName = add(new StringSetting("Notification", "[TeamRainy]", () -> page.getValue() == Page.Notification));
    public final ColorSetting color = add(new ColorSetting("Color", new Color(0, 255, 200), () -> page.getValue() == Page.Notification));
    public final ColorSetting pulse = add(new ColorSetting("Pulse", new Color(0, 255, 200), () -> page.getValue() == Page.Notification).injectBoolean(true));
    ...
    public HackSetting() {
        super("HackSetting", Category.Client);
        setChinese("客户端设置");
        INSTANCE = this;
    }
