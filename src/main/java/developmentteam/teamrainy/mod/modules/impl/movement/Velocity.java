...
import developmentteam.teamrainy.asm.accessors.IEntityVelocityUpdateS2CPacket;
import developmentteam.teamrainy.asm.accessors.IExplosionS2CPacket;
...
public class Velocity extends Module {
	...
	public void onVelocity(EntityVelocityUpdateEvent event) {
		...
		if (mode.is(Mode.Grim) || mode.is(Mode.Wall)) {
			...
			boolean insideBlock = TeamRainy.PLAYER.insideBlock;
	...
	public void onUpdate() {
		...
		if (flag) {
			if (lagBackTimer.passed(100) && (flagInWall.getValue() || !TeamRainy.PLAYER.insideBlock)) {
