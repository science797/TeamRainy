...
import developmentteam.teamrainy.asm.accessors.ILivingEntity;
...
import developmentteam.teamrainy.mod.modules.impl.combat.KillAura;
import developmentteam.teamrainy.mod.modules.impl.player.PacketEat;
...
public class AutoDupe extends Module {
            ...
            case Xin -> {
                ...
                switch (stage) {
                    ...
                    case Summon -> {
                        ...
                        InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                        TeamRainy.ROTATION.snapAt(TeamRainy.ROTATION.lastYaw, 89);
                    ...
                    case Tame -> {
                        ...
                        if (mc.player.hasVehicle()) {
                            ...
                            if (llama.isBaby()) {
                                ...
                                InventoryUtil.inventorySwap(slot, mc.player.getInventory().selectedSlot);
                                TeamRainy.ROTATION.lookAt(llama.getPos());
                    ...
                    case Kill -> {
                        ...
                        if (check()) {
                            TeamRainy.ROTATION.lookAt(llama.getEyePos());
    ...
    private void closeTo(BlockPos pos) {
        ...
        float forward = 1f;
        float side = 0;
        float yaw = TeamRainy.ROTATION.getRotation(pos.toCenterPos())[0];
