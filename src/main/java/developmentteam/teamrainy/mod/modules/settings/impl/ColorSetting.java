package developmentteam.teamrainy.mod.modules.settings.impl;
...
import developmentteam.teamrainy.mod.modules.impl.client.Colors;
...
public class ColorSetting extends Setting {
	...
	public void loadSetting() {
		this.value = new Color(TeamRainy.CONFIG.getInt(this.getLine(), defaultValue.getRGB()), true);
		this.isRainbow = TeamRainy.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = TeamRainy.CONFIG.getBoolean(this.getLine() + "Boolean", defaultBooleanValue);
		}
	}
}
